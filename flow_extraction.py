...
def parse_args():
    ...
    parser.add_argument(
        '--input',default=r'make_anetDatasets\video_list.txt',
    ...
    parser.add_argument(
        '--prefix',
        default=r'data\ActivityNet\videos',
        help='the prefix of input '
        'videos, used when input is a video list')
    parser.add_argument(
        '--dest',
        default='data\ActivityNet\\rawframes',
        help='the destination to save '
        'extracted frames')
    parser.add_argument(
        '--save-rgb', default=True,action='store_true', help='also save '
        'rgb frames')
    parser.add_argument(
        '--rgb-tmpl',
        default='image_{:05d}.jpg',
